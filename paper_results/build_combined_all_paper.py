...
SOURCES={ 'norway':  A/'norway_N100'/'raw_clean.csv',          # residential NO
          ...
          'kim':     A/'kim_commercial_N025'/'raw_clean.csv',
          'acn':     A/'acn_caltech_N015_b12_s01'/'raw_clean.csv' }  # per-STATION entities # commercial KR (wd)
OUT=ROOT/'dataset'/'combined'/'combined_all_sessions.csv'
