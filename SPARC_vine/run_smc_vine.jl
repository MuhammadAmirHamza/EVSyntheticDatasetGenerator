...
const SUFFIX = "_vine"            # SPARC_vine variant -> artifacts/<name>_vine/
...
const DATA_PATH         = joinpath(@__DIR__, "..", cfg.data...)   # data lives in parent repo
...
include(joinpath(@__DIR__, "smc_core_vine.jl"))
